...
const Component1 = () => {
    ...
    useEffect(() => {
        const getcountry = async () => {
            const req = await fetch("http://localhost:3003/country");
    ...
    useEffect(() => {
        const getstate = async () => {
            const resstate = await fetch(`http://localhost:3004/state/${countryid}`);
            ...
            <Container className="content">
                <div className="row">
                    <div className="col-sm-12">
                        <h5 className="mt-4 mb-4 fw-bold">Output  {countryid}</h5>
